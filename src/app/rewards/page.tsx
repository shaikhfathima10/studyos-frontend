  ...
  return (
    <div style={{ minHeight: "100vh", background: "#F8FAFC", maxWidth: 480, margin: "0 auto", paddingBottom: 100 }}>
      <div style={{ position: "sticky", top: 0, zIndex: 100, background: "#fff", borderBottom: "1px solid #E2E8F0", padding: "16px 20px", boxShadow: "0 1px 3px rgba(0,0,0,0.05)" }}>
        <h1 style={{ margin: 0, fontSize: 20, fontWeight: 900, color: "#1E293B" }}>ðŸ† Rewards</h1>
      ...
      <div style={{ padding: 20 }}>
        ...
        <div style={{ borderRadius: 24, padding: 24, background: "linear-gradient(135deg, #1E40AF, #4338CA, #7C3AED)", marginBottom: 16, color: "#fff", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 16 }}>
            <div>
              <p style={{ margin: 0, fontSize: 11, color: "rgba(255,255,255,0.6)", fontWeight: 700, textTransform: "uppercase", letterSpacing: "1px" }}>Level {level} Â· Scholar</p>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 12 }}>
          {[
            { icon: "ðŸ”¥", label: "Current Streak", val: `${streak?.streak || 0} days`, color: "#D97706", bg: "#FEF3C7" },
            { icon: "ðŸ’Ž", label: "Longest Streak", val: `${streak?.longest_streak || 0} days`, color: "#7C3AED", bg: "#EDE9FE" },
          ].map(s => (
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
            {badges.map((b: any) => (
              <div key={b.id} style={{ padding: "16px 14px", borderRadius: 14, background: b.earned ? "#EFF6FF" : "#F8FAFC", border: `1px solid ${b.earned ? "#BFDBFE" : "#E2E8F0"}`, opacity: b.earned ? 1 : 0.5, filter: b.earned ? "none" : "grayscale(1)" }}>
                ...
                {b.earned && <span style={{ fontSize: 10, fontWeight: 700, color: "#1E40AF", marginTop: 6, display: "block" }}>âœ“ Earned</span>}
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{ ...card, background: "#EFF6FF", border: "1px solid #BFDBFE" }}>
          <div style={{ display: "flex", gap: 14, alignItems: "center", marginBottom: 14 }}>
            ...
            <div>
              ...
              <p style={{ margin: 0, fontSize: 12, color: "#64748B" }}>Study together Â· earn bonus XP</p>
            </div>
          </div>
